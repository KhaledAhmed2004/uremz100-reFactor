/**
 * admin.load.js — Module entry point for Admin API load testing
 *
 * Usage:
 *   npm run load:admin          → k6 run --out web-dashboard (live dashboard at localhost:5665)
 *   npm run load:admin:stress   → stress scenario only
 *   npm run load:admin:baseline → baseline scenario only
 *
 * Prerequisites:
 *   1. npm run load:seed:admin  (creates fixtures)
...
export const handleSummary = createHandleSummary('admin');
