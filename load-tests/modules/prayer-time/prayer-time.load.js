/**
 * prayer-time.load.js — Module entry point for Prayer-Time API load testing
 *
 * Usage:
 *   npm run load:prayer-time          → k6 run --out web-dashboard (live dashboard at localhost:5665)
 *   npm run load:prayer-time:stress   → stress scenario only
 *   npm run load:prayer-time:baseline → baseline scenario only
 *
 * Prerequisites:
 *   1. npm run load:seed:prayer-time  (creates fixtures)
