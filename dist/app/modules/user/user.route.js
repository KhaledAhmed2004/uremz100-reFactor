...
router.get('/profiles', (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.USER), user_controller_1.UserController.getUserProfiles);
// --- Self Management (User/Doctor) ---
// Fetch own profile details
router.get('/me', (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.USER), user_controller_1.UserController.getUserProfile);
// Update own profile
router.patch('/me', (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.USER), upload.single('profileImage'), (0, validateRequest_1.default)(user_validation_1.UserValidation.updateUserZodSchema), user_controller_1.UserController.updateProfile);
// Request account self-deletion (soft-delete with 30-day recovery window).
// Restore happens through POST /auth/restore-account.
router.delete('/me', (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.USER), (0, idempotency_1.idempotency)('account-delete'), (0, validateRequest_1.default)(user_validation_1.UserValidation.deleteAccountZodSchema), user_controller_1.UserController.requestAccountDeletion);
...
router.post('/me/email-change/request', (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.USER), (0, idempotency_1.idempotency)('email-change-request'), (0, validateRequest_1.default)(user_validation_1.UserValidation.requestEmailChangeZodSchema), user_controller_1.UserController.requestEmailChange);
...
router.post('/me/email-change/confirm', (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.USER), (0, idempotency_1.idempotency)('email-change-confirm'), (0, validateRequest_1.default)(user_validation_1.UserValidation.confirmEmailChangeZodSchema), user_controller_1.UserController.confirmEmailChange);
// GDPR data export — returns everything the system stores about the
// requesting user as a JSON envelope.
router.post('/me/data-export', (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.USER), (0, idempotency_1.idempotency)('data-export'), user_controller_1.UserController.exportMyData);
// Sessions — list every device this user has logged in from. Returns
// metadata only; never the raw FCM/APNs token.
router.get('/me/sessions', (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.USER), user_controller_1.UserController.listMySessions);
...
router.post('/me/sessions/revoke-all', (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.USER), (0, idempotency_1.idempotency)('sessions-revoke-all'), user_controller_1.UserController.revokeAllMySessions);
...
// expiry (short-lived).
router.delete('/me/sessions/:tokenId', (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.USER), (0, validateRequest_1.default)(user_validation_1.UserValidation.revokeSessionZodSchema), user_controller_1.UserController.revokeMySession);
// --- Admin Only ---
