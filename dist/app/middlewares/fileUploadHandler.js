...
const fileUploadHandler = () => {
        ...
        destination: (req, file, cb) => {
            ...
            switch (file.fieldname) {
                ...
                case 'trailerFile':
                    ...
                    break;
                case 'doc':
                    uploadDir = path_1.default.join(baseUploadDir, 'doc');
                    break;
                default:
    ...
    const filterFilter = (req, file, cb) => {
        if (file.fieldname === 'image' || file.fieldname === 'profileImage' || file.fieldname === 'posterFile' || file.fieldname === 'thumbnailFile') {
            ...
            if (allowed.includes(file.mimetype)) {
                ...
                cb(new ApiError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, 'Only mp4/webm (video) and mp3/webm/ogg/wav/mp4 (audio) supported'));
            }
        }
