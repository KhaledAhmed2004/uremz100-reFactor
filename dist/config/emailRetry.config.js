...
exports.computeNextAttemptAt = exports.emailRetryConfig = exports.EMAIL_KINDS = void 0;
exports.EMAIL_KINDS = [
    'registration_otp',
    'forgot_password_otp',
    'email_change_otp',
...
const computeNextAttemptAt = (attempts, now = new Date()) => {
    const { baseBackoffSeconds, backoffMultiplier, jitter, maxBackoffSeconds, } = exports.emailRetryConfig;
    const raw = baseBackoffSeconds * Math.pow(backoffMultiplier, Math.max(0, attempts - 1));
